...
# Define variables
CSV_FILE_PATH_CUSTOMERS = '/mnt/data/customers.csv'
CSV_FILE_PATH_PAYMENTS = '/mnt/data/payments.csv'
CSV_FILE_PATH_ORDERS = '/mnt/data/orders.csv'
CSV_FILE_PATH_PRODUCTS = '/mnt/data/products.csv'
